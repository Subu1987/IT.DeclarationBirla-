sap.ui.define([
	...
	return Controller.extend("IT.DeclarationBirla.controller.HouseProperty", {

		onInit: function() {
			this._oRouter = this.getOwnerComponent().getRouter();
			this._oRouter.getRoute("HouseProperty").attachPatternMatched(this._onReadHousePropertyDataSet, this);
		...
		_onSaveHousePropertyDataSet: function(oData) {
			...
			oModel.create(oUrl, oData[0], {
					success: function(response) {
						MessageBox.information("The House Property data is saved");
					},
					error: function(error) {
						MessageBox.information("The House Property data is not saved");
					}
				}
